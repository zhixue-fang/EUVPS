...
from euvps.modeling.proposal_generative_head.decode_head import BaseDecodeHead, BaseDecodeHead_clips, BaseDecodeHead_clips_flow
# from mmseg.models.utils.parrots_wrapper import _specify_ddp_gpu_num
import attr

from IPython import embed

from euvps.modeling.proposal_generative_head.cffm_transformer import BasicLayer3d3
...
class CFFMHead_clips_resize1_8(BaseDecodeHead_clips_flow):
    ...
    """
    def __init__(self, feature_strides, short_proc, **kwargs):
    ...
    def forward(self, inputs, batch_size=None, num_clips=None, imgs=None):
        ...
        _x = self._transform_inputs(inputs)  # len=4, 1/4,1/8,1/16,1/32
        c1, c2, c3, c4 = _x
        ...
        #_c = F.interpolate(_c, size=(h2,w2),mode='bilinear',align_corners=False)


        _c_further=_c.reshape(batch_size, num_clips, -1, h2, w2)
        # print("_c_further:", _c_further.shape)
        # exit()
        ...
        x2 = self.dropout(_c2.flatten(0, 1))
